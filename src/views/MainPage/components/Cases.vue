      ...
      <div class="flex justify-end mb-6 lg:mb-[3.438rem]">
        <div class="w-full">
          <div class="flex justify-start lg:justify-end">
            <div class="w-1/2">
              <Heading class="!mb-0" heading="Кейсы" line="right" />
            </div>
          </div>
        </div>
      </div>
      <div v-if="getCategoryCases">
        <div class="mb-0" :class="{ ' mb-8 lg:!mb-16' : getCategoryCases.data.length != index + 1 }" v-for="(item, index) of getCategoryCases.data" :key="index">
          <p
