<template>
  <div class="relative pt-[3rem] pb-9 lg:pb-[8rem] bg-secondaryColor dark:bg-darkerBg">
    <img
      class="w-full h-full dark:hidden absolute left-0 top-0 object-cover rotate-180"
    ...
    <div class="relative z-10">
      <div class="container mx-auto px-4 lg:px-0">
        <Heading
          class="!mb-0 lg:!mb-[5.25rem] pl-4 lg:!pl-24"
        ...
        <div class="block lg:flex justify-between">
          <div
            class="w-4/5 mb-10 lg:mb-0 lg:w-3/5 mr-auto lg:mr-28 block lg:flex m-auto justify-between pt-10 lg:ml-0"
          >
            <div class="w-full mb-3 lg:mb-2 lg:w-third relative">
              <div
                style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25)"
                class="bg-mainColor flex lg:block w-full relative z-20 px-[0.875rem] py-3 items-center lg:items-baseline"
              >
                <img
                  class="w-[4.375rem] h-20 lg:h-auto lg:w-full mr-2 lg:mr-0 mb-0 lg:mb-[0.875rem]"
          ...
          <div class="w-11/12 mx-auto lg:mx-0 lg:w-1/4 md:w-full relative text-white">
            <img
              class="lg:w-11 w-6 h-auto absolute left-0 top-0 -translate-x-1/2 -translate-y-1/2"
              src="@/assets/img/team/quote.png"
              alt=""
            />
            <div
